...
urlpatterns = [
    ...
    path('editar-cooperativa/', views.edit_cooperative_view, name='edit_cooperative'),
    path('analizar-cooperativa/', views.analyze_cooperative_view, name='analyze_cooperative'),
