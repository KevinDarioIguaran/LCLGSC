...
from .models import ActiveSite, Hours, DayBlock, VacationBlock, WeekendDay, WeekendDayHour

def BlocksView(view_func):
    """
    Decorator that blocks the view if the site isn’t active based on:
        - weekends
        - day blocks
        - vacation blocks
        - active hours
